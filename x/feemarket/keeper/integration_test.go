...
// This integration test has been moved to carbon as fee_market_integration_test.go
//import (
//	"encoding/json"
//	"math/big"
//	"strings"
...
//	)
//	// commenting out test case for feemarket for cosmos tx because min-gas-price(local) for carbon is overridden by carbon fee
//	// of 1 SWTH = 10^8 SWTH which is greater than the minimum gas price set in feemarket(50000 SWTH)
