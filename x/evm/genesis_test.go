...
func (suite *EvmTestSuite) TestInitGenesisAddressMapping() {
	...
	}{
		{
			...
			&types.GenesisState{
				...
				EthToCosmosAddressMap: map[string]string{
					tests.Maker1.String(): tests.Maker2.String(),
					tests.Maker3.String(): tests.Maker4.String(),
					tests.Maker5.String(): tests.Maker6.String(),
				},
				CosmosToEthAddressMap: map[string]string{
					tests.Maker2.String(): tests.Maker1.String(),
					tests.Maker4.String(): tests.Maker3.String(),
					tests.Maker6.String(): tests.Maker5.String(),
				},
			},
		},
		{
	...
	suite.Run(testCases[0].name, func() {
		...
		suite.Require().Equal(sdk.AccAddress(ethCosmosMap.Get(tests.Maker1)).String(), testCases[0].genState.EthToCosmosAddressMap[tests.Maker1.String()])
		suite.Require().Equal(sdk.AccAddress(ethCosmosMap.Get(tests.Maker3)).String(), testCases[0].genState.EthToCosmosAddressMap[tests.Maker3.String()])
		suite.Require().Equal(sdk.AccAddress(ethCosmosMap.Get(tests.Maker5)).String(), testCases[0].genState.EthToCosmosAddressMap[tests.Maker5.String()])

		suite.Require().Equal(sdk.AccAddress(cosmosEthMap.Get(tests.Maker2)).String(), testCases[0].genState.CosmosToEthAddressMap[tests.Maker2.String()])
		suite.Require().Equal(sdk.AccAddress(cosmosEthMap.Get(tests.Maker4)).String(), testCases[0].genState.CosmosToEthAddressMap[tests.Maker4.String()])
		suite.Require().Equal(sdk.AccAddress(cosmosEthMap.Get(tests.Maker6)).String(), testCases[0].genState.CosmosToEthAddressMap[tests.Maker6.String()])
...
func (suite *EvmTestSuite) TestExportGenesisAddressMapping() {
	...
	suite.Run(testCases[0].name, func() {
		...
		suite.app.AccountKeeper.SetCorrespondingAddresses(suite.ctx, tests.Maker3, tests.Maker4)
		...
		suite.Require().Equal(sdk.AccAddress(ethCosmosMap.Get(tests.Maker2)).String(), genesisState.EthToCosmosAddressMap[tests.Maker2.String()])
		suite.Require().Equal(sdk.AccAddress(ethCosmosMap.Get(tests.Maker4)).String(), genesisState.EthToCosmosAddressMap[tests.Maker4.String()])

		suite.Require().Equal(sdk.AccAddress(cosmosEthMap.Get(tests.Maker1)).String(), genesisState.CosmosToEthAddressMap[tests.Maker1.String()])
		suite.Require().Equal(sdk.AccAddress(cosmosEthMap.Get(tests.Maker3)).String(), genesisState.CosmosToEthAddressMap[tests.Maker3.String()])
