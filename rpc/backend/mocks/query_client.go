...
// MergedAccountsAddressMappings provides a mock function with given fields: ctx, in, opts
func (_m *QueryClient) MergedAccountsAddressMappings(ctx context.Context, in *types.QueryMergedAccountsMappingRequest, opts ...grpc.CallOption) (*types.QueryMergedAccountsMappingResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *types.QueryMergedAccountsMappingResponse
	if rf, ok := ret.Get(0).(func(context.Context, *types.QueryMergedAccountsMappingRequest, ...grpc.CallOption) *types.QueryMergedAccountsMappingResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*types.QueryMergedAccountsMappingResponse)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *types.QueryMergedAccountsMappingRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
